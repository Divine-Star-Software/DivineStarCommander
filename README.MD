...
| **showAtSleep**             | **message** : string, **type** : MessageType, **row** : number, **col** ?: number,**sleep** ?: number | self    | Logs message at given row and sleeps.                                            |
...
```typescript
dsLog.BR.R.I.show("this is red text");
```
